...
1. Read `common.md` for the Iron Law, Project Config, Report Template, and Health Score rules
2. Read `source-coverage.md` for book-level coverage, exceptions, and tradeoffs
3. Read `test-decay-risks.md` for test-space symptom definitions and source attributions
...
Scope Detection from `common.md` to determine the review scope before proceeding.
